...
"""
Reads the stdin line by line and computes the metrics.
Input format: <IP> - [<date>] "GET /projects/260 HTTP/1.1" <status> <size>
For every 10 lines or on a keyboard interrupt, prints:
...
def print_stats(size, status_codes):
    ...
    Args:
        ...
        status_codes (dict): The count of the accumulated status codes.
    """
