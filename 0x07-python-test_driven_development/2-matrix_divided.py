...
def matrix_divided(matrix, div):
    ...
    # Check that all rows have the same equal length
    # Get the length of the first row of the  Matrix:wq
    ...
    # Check that the div is a number
    # If div is not a number, raises an error
    ...
    # Iterate over each row in the matrix equation
    new_matrix = []
    for row in matrix:
        ...
        # Append the new row to the new matrix formation
